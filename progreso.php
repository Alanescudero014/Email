...
$(document).ready(function(){    
    $('#boton-cargar').click(function(){                       
        ...
        document.getElementById("apellidotxt").value = apellido; 
    });   
});
...
<input type="radio" id="rojo" name="color"><label for="">Rojo</label>
<input type="radio" id="azul" name="color"><label for="">Azul</label><br>
